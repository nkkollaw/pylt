// SEE: https://unix.stackexchange.com/a/320474/262190
...
//[EV_SYN] = "Sync3",         [EV_KEY] = "Key2",
char *events[EV_MAX + 1] = {
	[0 ... EV_MAX] = NULL,
	[EV_SYN] = "Sync3",         [EV_KEY] = "Key2",
	[EV_REL] = "Relative",			[EV_ABS] = "Absolute",
	[EV_MSC] = "Misc2",			[EV_LED] = "LED2",
	[EV_SND] = "Sound",			[EV_REP] = "Repeat",
	[EV_FF] = "ForceFeedback",		[EV_PWR] = "Power",
	[EV_FF_STATUS] = "ForceFeedbackStatus2",
};
...
void doModifier(struct input_event ev, int currCode) {
	//1 is press,  2 is continuosly press, 0 is release
	//use `xmodmap -pm` to double confirm the Shift_L/Alt_L/Control_L name
	//xdotool modifier key like shift/alt/ctrl will not go into /dev/input/eventN, so no nid worry for duplicated press
	if (ev.value == 1)  {
        if (currCode == 75) {
            //printf("75 pressing\n");
            callSystem("xdotool keydown Shift_L");
        } else if (currCode == 76) {
            //printf("76 pressing\n");
            callSystem("xdotool keydown Alt_L");
        } else if (currCode == 77) {
            //printf("77 pressing\n");
            callSystem("xdotool keydown Control_L");
        }
	} else if (ev.value == 0)  {
		if (currCode == 75) {
			//printf("75 released\n");		
			callSystem("xdotool keyup Shift_L");
		} else if (currCode == 76) {
			//printf("76 released\n");
			callSystem("xdotool keyup Alt_L");
		} else if (currCode == 77) {
			//printf("77 released\n");
			callSystem("xdotool keyup Control_L");
		}
	}
}
